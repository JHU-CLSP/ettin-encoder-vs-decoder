...
if __name__ == "__main__":
    ...
    """
    # NOTE: even though it has a "split" that's really just the basename of the folder
    # This script is used to prepare the dataset for training, since it needs to be decompressed
    python ./bin/decompress.py \
  --data_path data/mmbert-decay/train/ \
  --read_split dclm-filtered-sampled-decay-10B \
  --decompress \
  --delete_zip 
    """
